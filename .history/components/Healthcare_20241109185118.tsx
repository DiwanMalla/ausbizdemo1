  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
      <div className="container px-4 md:px-6">
        ...
        <Card className="bg-white dark:bg-gray-900 text-foreground dark:text-foreground shadow-lg dark:shadow-gray-800 p-6 rounded-lg">
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            <p className="text-foreground dark:text-foreground/80">
              ...
              integration with AWS-based solutions. Our approach streamlines the
              management of electronic health records (EHR), ensuring seamless
              data exchange across various healthcare systems and improving
              patient care.
            </p>
            <p className="text-foreground dark:text-foreground/80">
              Our team specializes in cloud solutions using AWS services such as
              AWS Lambda, API Gateway, and DynamoDB, ensuring a serverless,
              scalable, and secure architecture for handling sensitive
              healthcare data. We focus on maintaining compliance with
              regulations such as HIPAA while enhancing operational efficiency.
            </p>
            <p className="text-foreground dark:text-foreground/80">
