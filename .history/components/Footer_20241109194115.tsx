      ...
      <div className="container px-4 md:px-6 mx-auto">
          ...
          <div>
            ...
            <div className="flex space-x-6">
              <a href="#" aria-label="Facebook">
                <FacebookIcon className="w-6 h-6 dark:text-gray-300 hover:text-blue-600 transition-colors" />
              </a>
              <a href="#" aria-label="Twitter">
                <TwitterIcon className="w-6 h-6 dark:text-gray-300 hover:text-blue-400 transition-colors" />
              </a>
              <a href="#" aria-label="LinkedIn">
                <LinkedinIcon className="w-6 h-6 dark:text-gray-300 hover:text-blue-700 transition-colors" />
              </a>
            </div>
          </div>
        </div>
        <div className="mt-10 flex justify-between items-center border-t border-gray-700 pt-6">
          ...
          <div className="flex space-x-4">
            <Button className="bg-transparent text-black bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white">
              Subscribe
            </Button>
          </div>
        </div>
