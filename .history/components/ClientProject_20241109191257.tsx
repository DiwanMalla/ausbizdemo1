...
const projects = [
  {
    ...
    details:
      "Implemented serverless architecture with AWS Lambda and DynamoDB, allowing for real-time inventory updates and order management. Integrated with third-party payment APIs. This platform is designed to handle high traffic during peak shopping seasons.",
    clientLogo: "https://via.placeholder.com/150?text=Client+Logo+1", // Placeholder for client logo image
    projectImage:
      "https://via.placeholder.com/600x400?text=E-commerce+Platform", // Placeholder for project image
  },
  {
    title: "AI-Powered Chatbot",
    description: "Developed an intelligent customer service chatbot",
    details:
      "Utilized AWS Lex and Amazon Comprehend for natural language processing, automating customer queries and providing instant support with AI learning capabilities. Integrated with the client’s CRM for seamless data synchronization.",
    clientLogo: "https://via.placeholder.com/150?text=Client+Logo+2", // Placeholder for client logo image
    projectImage: "https://via.placeholder.com/600x400?text=AI-Powered+Chatbot", // Placeholder for project image
  },
  // Add more projects...
];
